...
SCENIC_ROOT = "/home/chenzonggui/software/SCENIC"
...
def main():
    ...
    if GENOME == "mm10":
        MM_TFS_FNAME = SCENIC_ROOT + "/allTFs_mm.txt"
        DATABASES_GLOB = SCENIC_ROOT + "/mm10_*.feather"
        MOTIF_ANNOTATIONS_FNAME = SCENIC_ROOT + "/motifs-v10nr_clust-nr.mgi-m0.001-o0.0.tbl"
    elif GENOME == "hg38":
        MM_TFS_FNAME = SCENIC_ROOT + "/allTFs_hg38.txt"
        DATABASES_GLOB = SCENIC_ROOT + "/hg38_*.feather"
        MOTIF_ANNOTATIONS_FNAME = SCENIC_ROOT + "/motifs-v10nr_clust-nr.hgnc-m0.001-o0.0.tbl"
    else:
        assert False
    ...
    # rowname is cell, colname is gene
