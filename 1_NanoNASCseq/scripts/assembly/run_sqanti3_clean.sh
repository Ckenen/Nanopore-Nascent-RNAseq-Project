...
# set +e
${SQANTI3_ROOT}/sqanti3_qc.py -d ${outdir} --cpus ${threads} --skipORF --report pdf ${gtf1} ${gtf2} ${fasta} && \
...
rm -f ${outdir}/*.genePred
rm -f ${outdir}/*.fasta
rm -f ${outdir}/*.gff
rm -f ${outdir}/*.gtf
rm -f ${outdir}/*_junctions.txt
rm -f ${outdir}/*params.txt
rm -rf ${outdir}/GMST
rm -rf ${outdir}/RTS 
# exit 0